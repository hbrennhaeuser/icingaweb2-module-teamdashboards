...
// Dashboard.ini from icingaweb2 commit #81a3be7 / Release v2.12.2
 ...
 *
 */
class Teamdashboard extends AbstractWidget
{
    /**
    ...
    {
        $url = Url::fromPath('teamdashboards/team-dashboard')->getUrlWithout($this->tabParam);
